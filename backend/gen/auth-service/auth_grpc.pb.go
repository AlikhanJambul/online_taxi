...
func (c *authServiceClient) UpdateFCMToken(ctx context.Context, in *UpdateFCMRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func _AuthService_UpdateFCMToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).UpdateFCMToken(ctx, req.(*UpdateFCMRequest))
	}
	return interceptor(ctx, in, info, handler)
}
